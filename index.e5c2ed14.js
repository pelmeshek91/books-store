...
var $136eefed1c920c92$exports = {};

(parcelRequire("lW9CP")).register(JSON.parse('{"7BhwC":"index.e5c2ed14.js","cpiP6":"modal-img.e86d48d2.svg","9lMr0":"support-svg.b733e313.svg","6B5km":"general-svg.svg.a33baf69.svg","lL2W6":"shoppingList.9d1ce58f.js","2ba0z":"shoppingList.fc030349.js"}'));
...
var $i7Hen = parcelRequire("i7Hen");
const $a18a0f3990fa6bc9$export$a74fd290e202b4c6 = (data)=>{
    const markup = data.reduce((acc, { list_name: list_name  })=>acc + `<li class='item-category'><button type="button" class='btn-categoty'>${list_name}</button></li>`, '<li class="item-category"><button type="button" class="btn-categoty active-text">All categories</button></li>');
    return markup;
};



var $cutNd = parcelRequire("cutNd");

var $4HIy1 = parcelRequire("4HIy1");
const $95e6001648cbb8d8$export$be7daf19ed474bd3 = document.querySelector(".categories_list");
const $95e6001648cbb8d8$export$3dddb10616f03c3a = "/category-list";
const $95e6001648cbb8d8$export$94bc654d13d3e8cb = async (point)=>{
    try {
        const results = await (0, $i7Hen.fetchBooks)(point);
        $95e6001648cbb8d8$export$be7daf19ed474bd3.insertAdjacentHTML("afterbegin", (0, $a18a0f3990fa6bc9$export$a74fd290e202b4c6)(results));
        return results;
    } catch (error) {
        console.log(error);
    }
};
const $95e6001648cbb8d8$export$f1b919af109c22bf = (e)=>{
    const selectCateg = e.target.textContent;
    if (selectCateg === "All categories") {
        $95e6001648cbb8d8$var$switchTextDecor(e);
    ...
    if (e.target.nodeName === "BUTTON") {
        ...
        (0, $cutNd.handleClickOnFilter)(categoryName);
    }
};
function $95e6001648cbb8d8$var$switchTextDecor(e) {
    const activeClass = $95e6001648cbb8d8$export$be7daf19ed474bd3.querySelectorAll(".active-text");
...
parcelRequire("aaoiW");
(0, $95e6001648cbb8d8$export$94bc654d13d3e8cb)((0, $95e6001648cbb8d8$export$3dddb10616f03c3a));
(0, $4HIy1.createMurkUpAllBooks)();
(0, $95e6001648cbb8d8$export$be7daf19ed474bd3).addEventListener("click", (0, $95e6001648cbb8d8$export$f1b919af109c22bf));
(0, $4HIy1.sectionBooksEl).addEventListener("click", (0, $4HIy1.onHandleCategoriesForButton));


//# sourceMappingURL=index.e5c2ed14.js.map
