...
var $b2268d9054503aa1$exports = {};

(parcelRequire("9xqYB")).register(JSON.parse('{"ikoiw":"index.e86cebe1.js","8xhEQ":"general-svg.svg.a33baf69.svg","hd2jO":"modal-img.e86d48d2.svg","cCn1N":"support-svg.b733e313.svg","hGc3w":"shoppingList.4c49e876.js","SrxM1":"shoppingList.4a972488.js"}'));
...
var $lsSx6 = parcelRequire("lsSx6");
const $e1d8094df58f8ed8$export$a74fd290e202b4c6 = (data)=>{
...
var $3Ww7B = parcelRequire("3Ww7B");

var $aMsnd = parcelRequire("aMsnd");
const $11430cac462bb780$export$be7daf19ed474bd3 = document.querySelector(".categories_list");
const $11430cac462bb780$export$3dddb10616f03c3a = "/category-list";
const $11430cac462bb780$export$94bc654d13d3e8cb = async (point)=>{
    try {
        const results = await (0, $lsSx6.fetchBooks)(point);
        $11430cac462bb780$export$be7daf19ed474bd3.insertAdjacentHTML("afterbegin", (0, $e1d8094df58f8ed8$export$a74fd290e202b4c6)(results));
        return results;
    } catch (error) {
        console.log(error);
    }
};
const $11430cac462bb780$export$f1b919af109c22bf = (e)=>{
    const selectCateg = e.target.textContent;
    if (selectCateg === "All categories") {
        $11430cac462bb780$var$switchTextDecor(e);
    ...
    if (e.target.nodeName === "BUTTON") {
        ...
        (0, $3Ww7B.handleClickOnFilter)(categoryName);
    }
};
function $11430cac462bb780$var$switchTextDecor(e) {
    const activeClass = $11430cac462bb780$export$be7daf19ed474bd3.querySelectorAll(".active-text");
...
parcelRequire("9E0k7");
(0, $11430cac462bb780$export$94bc654d13d3e8cb)((0, $11430cac462bb780$export$3dddb10616f03c3a));
(0, $aMsnd.createMurkUpAllBooks)();
(0, $11430cac462bb780$export$be7daf19ed474bd3).addEventListener("click", (0, $11430cac462bb780$export$f1b919af109c22bf));
(0, $aMsnd.sectionBooksEl).addEventListener("click", (0, $aMsnd.onHandleCategoriesForButton));

})();
//# sourceMappingURL=index.e86cebe1.js.map
