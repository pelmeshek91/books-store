 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class T{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class A{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable((()=>t(h.UNAUTHENTICATED)))}shutdown(){}}class N{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable((()=>t(this.token.user)))}shutdown(){this.changeListener=null}}class C{constructor(e){this.t=e,this.currentUser=h.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){let n=this.i;const r=e=>this.i!==n?(n=this.i,t(e)):Promise.resolve();let i=new S;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new S,e.enqueueRetryable((()=>r(this.currentUser)))};const o=()=>{const t=i;e.enqueueRetryable((async()=>{await t.promise,await r(this.currentUser)}))},s=e=>{g("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=e,this.auth.addAuthTokenListener(this.o),o()};this.t.onInit((e=>s(e))),setTimeout((()=>{if(!this.auth){const e=this.t.getImmediate({optional:!0});e?s(e):(g("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new S)}}),0),o()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then((t=>this.i!==e?(g("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):t?(x("string"==typeof t.accessToken),new T(t.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return x(null===e||"string"==typeof e),new h(e)}}class O{constructor(e,t,n){this.h=e,this.l=t,this.m=n,this.type="FirstParty",this.user=h.FIRST_PARTY,this.g=new Map}p(){return this.m?this.m():null}get headers(){this.g.set("X-Goog-AuthUser",this.h);const e=this.p();return e&&this.g.set("Authorization",e),this.l&&this.g.set("X-Goog-Iam-Authorization-Token",this.l),this.g}}class D{constructor(e,t,n){this.h=e,this.l=t,this.m=n}getToken(){return Promise.resolve(new O(this.h,this.l,this.m))}start(e,t){e.enqueueRetryable((()=>t(h.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class R{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class P{constructor(e){this.I=e,this.forceRefresh=!1,this.appCheck=null,this.T=null}start(e,t){const n=e=>{null!=e.error&&g("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${e.error.message}`);const n=e.token!==this.T;return this.T=e.token,g("FirebaseAppCheckTokenProvider",`Received ${n?"new":"existing"} token.`),n?t(e.token):Promise.resolve()};this.o=t=>{e.enqueueRetryable((()=>n(t)))};const r=e=>{g("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=e,this.appCheck.addTokenListener(this.o)};this.I.onInit((e=>r(e))),setTimeout((()=>{if(!this.appCheck){const e=this.I.getImmediate({optional:!0});e?r(e):g("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then((e=>e?(x("string"==typeof e.token),this.T=e.token,new R(e.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K{constructor(e,t,n,r){this.indexId=e,this.collectionGroup=t,this.fields=n,this.indexState=r}}function H(e){return e.fields.find((e=>2===e.kind))}function X(e){return e.fields.filter((e=>2!==e.kind))}K.UNKNOWN_ID=-1;class Q{constructor(e,t){this.fieldPath=e,this.kind=t}}class J{constructor(e,t){this.sequenceNumber=e,this.offset=t}static empty(){return new J(0,ee.min())}}function Y(e,t){const n=e.toTimestamp().seconds,r=e.toTimestamp().nanoseconds+1,i=V.fromTimestamp(1e9===r?new B(n+1,0):new B(n,r));return new ee(i,$.empty(),t)}function Z(e){return new ee(e.readTime,e.key,-1)}class ee{constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}static min(){return new ee(V.min(),$.empty(),-1)}static max(){return new ee(V.max(),$.empty(),-1)}}function te(e,t){let n=e.readTime.compareTo(t.readTime);return 0!==n?n:(n=$.comparator(e.documentKey,t.documentKey),0!==n?n:F(e.largestBatchId,t.largestBatchId))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He extends re{constructor(e,t){super(),this.ht=e,this.currentSequenceNumber=t}}function Xe(e,t){const n=E(e);return ae.M(n.ht,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qe(e){let t=0;for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t++;return t}function Je(e,t){for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t(n,e[n])}function Ye(e){for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jt{constructor(e){this.value=e}static empty(){return new jt({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!Dt(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Rt(t)}setAll(e){let t=G.emptyPath(),n={},r=[];e.forEach(((e,i)=>{if(!t.isImmediateParentOf(i)){const e=this.getFieldsMap(t);this.applyChanges(e,n,r),n={},r=[],t=i.popLast()}e?n[i.lastSegment()]=Rt(e):r.push(i.lastSegment())}));const i=this.getFieldsMap(t);this.applyChanges(i,n,r)}delete(e){const t=this.field(e.popLast());Dt(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return xt(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let r=t.mapValue.fields[e.get(n)];Dt(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=r),t=r}return t.mapValue.fields}applyChanges(e,t,n){Je(t,((t,n)=>e[t]=n));for(const t of n)delete e[t]}clone(){return new jt(Rt(this.value))}}function Bt(e){const t=[];return Je(e.fields,((e,n)=>{const r=new G([e]);if(Dt(n)){const e=Bt(n.mapValue).fields;if(0===e.length)t.push(r);else for(const n of e)t.push(r.child(n))}else t.push(r)})),new ot(t)
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}class Vt{constructor(e,t,n,r,i,o,s){this.key=e,this.documentType=t,this.version=n,this.readTime=r,this.createTime=i,this.data=o,this.documentState=s}static newInvalidDocument(e){return new Vt(e,0,V.min(),V.min(),V.min(),jt.empty(),0)}static newFoundDocument(e,t,n,r){return new Vt(e,1,t,V.min(),n,r,0)}static newNoDocument(e,t){return new Vt(e,2,t,V.min(),V.min(),jt.empty(),0)}static newUnknownDocument(e,t){return new Vt(e,3,t,V.min(),V.min(),jt.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(V.min())||2!==this.documentType&&0!==this.documentType||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=jt.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=jt.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=V.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return 1===this.documentState}get hasCommittedMutations(){return 2===this.documentState}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return 0!==this.documentType}isFoundDocument(){return 1===this.documentType}isNoDocument(){return 2===this.documentType}isUnknownDocument(){return 3===this.documentType}isEqual(e){return e instanceof Vt&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Vt(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kt{}class Ht extends Kt{constructor(e,t,n){super(),this.field=e,this.op=t,this.value=n}static create(e,t,n){return e.isKeyField()?"in"===t||"not-in"===t?this.createKeyFieldInFilter(e,t,n):new on(e,t,n):"array-contains"===t?new un(e,n):"in"===t?new ln(e,n):"not-in"===t?new hn(e,n):"array-contains-any"===t?new dn(e,n):new Ht(e,t,n)}static createKeyFieldInFilter(e,t,n){return"in"===t?new sn(e,n):new an(e,n)}matches(e){const t=e.data.field(this.field);return"!="===this.op?null!==t&&this.matchesComparison(Et(t,this.value)):null!==t&&bt(this.value)===bt(t)&&this.matchesComparison(Et(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return 0===e;case"!=":return 0!==e;case">":return e>0;case">=":return e>=0;default:return b()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}getFirstInequalityField(){return this.isInequality()?this.field:null}}class Xt extends Kt{constructor(e,t){super(),this.filters=e,this.op=t,this.lt=null}static create(e,t){return new Xt(e,t)}matches(e){return Qt(this)?void 0===this.filters.find((t=>!t.matches(e))):void 0!==this.filters.find((t=>t.matches(e)))}getFlattenedFilters(){return null!==this.lt||(this.lt=this.filters.reduce(((e,t)=>e.concat(t.getFlattenedFilters())),[])),this.lt}getFilters(){return Object.assign([],this.filters)}getFirstInequalityField(){const e=this.ft((e=>e.isInequality()));return null!==e?e.field:null}ft(e){for(const t of this.getFlattenedFilters())if(e(t))return t;return null}}function Qt(e){return"and"===e.op}function Jt(e){return"or"===e.op}function Yt(e){return Zt(e)&&Qt(e)}function Zt(e){for(const t of e.filters)if(t instanceof Xt)return!1;return!0}function en(e){if(e instanceof Ht)return e.field.canonicalString()+e.op.toString()+_t(e.value);if(Yt(e))return e.filters.map((e=>en(e))).join(",");{const t=e.filters.map((e=>en(e))).join(",");return`${e.op}(${t})`}}function tn(e,t){return e instanceof Ht?function(e,t){return t instanceof Ht&&e.op===t.op&&e.field.isEqual(t.field)&&xt(e.value,t.value)}(e,t):e instanceof Xt?function(e,t){return t instanceof Xt&&e.op===t.op&&e.filters.length===t.filters.length&&e.filters.reduce(((e,n,r)=>e&&tn(n,t.filters[r])),!0)}(e,t):void b()}function nn(e,t){const n=e.filters.concat(t);return Xt.create(n,e.op)}function rn(e){return e instanceof Ht?function(e){return`${e.field.canonicalString()} ${e.op} ${_t(e.value)}`}(e):e instanceof Xt?function(e){return e.op.toString()+" {"+e.getFilters().map(rn).join(" ,")+"}"}(e):"Filter"}class on extends Ht{constructor(e,t,n){super(e,t,n),this.key=$.fromName(n.referenceValue)}matches(e){const t=$.comparator(e.key,this.key);return this.matchesComparison(t)}}class sn extends Ht{constructor(e,t){super(e,"in",t),this.keys=cn("in",t)}matches(e){return this.keys.some((t=>t.isEqual(e.key)))}}class an extends Ht{constructor(e,t){super(e,"not-in",t),this.keys=cn("not-in",t)}matches(e){return!this.keys.some((t=>t.isEqual(e.key)))}}function cn(e,t){var n;return((null===(n=t.arrayValue)||void 0===n?void 0:n.values)||[]).map((e=>$.fromName(e.referenceValue)))}class un extends Ht{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return Nt(t)&&It(t.arrayValue,this.value)}}class ln extends Ht{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return null!==t&&It(this.value.arrayValue,t)}}class hn extends Ht{constructor(e,t){super(e,"not-in",t)}matches(e){if(It(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return null!==t&&!It(this.value.arrayValue,t)}}class dn extends Ht{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!Nt(t)||!t.arrayValue.values)&&t.arrayValue.values.some((e=>It(this.value.arrayValue,e)))}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jn{constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}get(e){const t=this.mapKeyFn(e),n=this.inner[t];if(void 0!==n)for(const[t,r]of n)if(this.equalsFn(t,e))return r}has(e){return void 0!==this.get(e)}set(e,t){const n=this.mapKeyFn(e),r=this.inner[n];if(void 0===r)return this.inner[n]=[[e,t]],void this.innerSize++;for(let n=0;n<r.length;n++)if(this.equalsFn(r[n][0],e))return void(r[n]=[e,t]);r.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),n=this.inner[t];if(void 0===n)return!1;for(let r=0;r<n.length;r++)if(this.equalsFn(n[r][0],e))return 1===n.length?delete this.inner[t]:n.splice(r,1),this.innerSize--,!0;return!1}forEach(e){Je(this.inner,((t,n)=>{for(const[t,r]of n)e(t,r)}))}isEmpty(){return Ye(this.inner)}size(){return this.innerSize}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class jr{constructor(){this.onExistenceFilterMismatchCallbacks=new Map}static get instance(){return Br}static getOrCreateInstance(){return null===Br&&(Br=new jr),Br}onExistenceFilterMismatch(e){const t=Symbol();return this.onExistenceFilterMismatchCallbacks.set(t,e),()=>this.onExistenceFilterMismatchCallbacks.delete(t)}notifyOnExistenceFilterMismatch(e){this.onExistenceFilterMismatchCallbacks.forEach((t=>t(e)))}}let Br=null;
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kr{constructor(e,t,n,r,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,n){const r=new Map;return r.set(e,Hr.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new Kr(V.min(),r,new Ze(F),Vn(),Qn())}}class Hr{constructor(e,t,n,r,i){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new Hr(n,t,Qn(),Qn(),Qn())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mi{constructor(e){this.fe=e}}function Fi(e,t){const n=t.key,r={prefixPath:n.getCollectionPath().popLast().toArray(),collectionGroup:n.collectionGroup,documentId:n.path.lastSegment(),readTime:Ui(t.readTime),hasCommittedMutations:t.hasCommittedMutations};if(t.isFoundDocument())r.document=function(e,t){return{name:fi(e,t.key),fields:t.data.value.mapValue.fields,updateTime:ai(e,t.version.toTimestamp()),createTime:ai(e,t.createTime.toTimestamp())}}(e.fe,t);else if(t.isNoDocument())r.noDocument={path:n.path.toArray(),readTime:ji(t.version)};else{if(!t.isUnknownDocument())return b();r.unknownDocument={path:n.path.toArray(),version:ji(t.version)}}return r}function Ui(e){const t=e.toTimestamp();return[t.seconds,t.nanoseconds]}function ji(e){const t=e.toTimestamp();return{seconds:t.seconds,nanoseconds:t.nanoseconds}}function Bi(e){const t=new B(e.seconds,e.nanoseconds);return V.fromTimestamp(t)}function Vi(e,t){const n=(t.baseMutations||[]).map((t=>Ii(e.fe,t)));for(let e=0;e<t.mutations.length-1;++e){const n=t.mutations[e];if(e+1<t.mutations.length&&void 0!==t.mutations[e+1].transform){const r=t.mutations[e+1];n.updateTransforms=r.transform.fieldTransforms,t.mutations.splice(e+1,1),++e}}const r=t.mutations.map((t=>Ii(e.fe,t))),i=B.fromMillis(t.localWriteTimeMs);return new Or(t.batchId,i,n,r)}function zi(e){const t=Bi(e.readTime),n=void 0!==e.lastLimboFreeSnapshotVersion?Bi(e.lastLimboFreeSnapshotVersion):V.min();let r;var i;return void 0!==e.query.documents?(x(1===(i=e.query).documents.length),r=Nn(En(gi(i.documents[0])))):r=function(e){return Nn(_i(e))}(e.query),new Li(r,e.targetId,"TargetPurposeListen",e.lastListenSequenceNumber,t,n,ct.fromBase64String(e.resumeToken))}function qi(e,t){const n=ji(t.snapshotVersion),r=ji(t.lastLimboFreeSnapshotVersion);let i;i=yn(t.target)?Ei(e.fe,t.target):ki(e.fe,t.target);const o=t.resumeToken.toBase64();return{targetId:t.targetId,canonicalId:mn(t.target),readTime:n,resumeToken:o,lastListenSequenceNumber:t.sequenceNumber,lastLimboFreeSnapshotVersion:r,query:i}}function Wi(e){const t=_i({parent:e.parent,structuredQuery:e.structuredQuery});return"LAST"===e.limitType?On(t,t.limit,"L"):t}function Gi(e,t){return new Rr(t.largestBatchId,Ii(e.fe,t.overlayMutation))}function $i(e,t){const n=t.path.lastSegment();return[e,xe(t.path.popLast()),n]}function Ki(e,t,n,r){return{indexId:e,uid:t.uid||"",sequenceNumber:n,readTime:ji(r.readTime),documentKey:xe(r.documentKey.path),largestBatchId:r.largestBatchId}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hi{getBundleMetadata(e,t){return Xi(e).get(t).next((e=>{if(e)return{id:(t=e).bundleId,createTime:Bi(t.createTime),version:t.version};var t}))}saveBundleMetadata(e,t){var n;return Xi(e).put({bundleId:(n=t).id,createTime:ji(li(n.createTime)),version:n.version})}getNamedQuery(e,t){return Qi(e).get(t).next((e=>{if(e)return{name:(t=e).name,query:Wi(t.bundledQuery),readTime:Bi(t.readTime)};var t}))}saveNamedQuery(e,t){return Qi(e).put(function(e){return{name:e.name,readTime:ji(li(e.readTime)),bundledQuery:e.bundledQuery}}(t))}}function Xi(e){return Xe(e,"bundles")}function Qi(e){return Xe(e,"namedQueries")}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ji{constructor(e,t){this.serializer=e,this.userId=t}static de(e,t){const n=t.uid||"";return new Ji(e,n)}getOverlay(e,t){return Yi(e).get($i(this.userId,t)).next((e=>e?Gi(this.serializer,e):null))}getOverlays(e,t){const n=Gn();return oe.forEach(t,(t=>this.getOverlay(e,t).next((e=>{null!==e&&n.set(t,e)})))).next((()=>n))}saveOverlays(e,t,n){const r=[];return n.forEach(((n,i)=>{const o=new Rr(t,i);r.push(this.we(e,o))})),oe.waitFor(r)}removeOverlaysForBatchId(e,t,n){const r=new Set;t.forEach((e=>r.add(xe(e.getCollectionPath()))));const i=[];return r.forEach((t=>{const r=IDBKeyRange.bound([this.userId,t,n],[this.userId,t,n+1],!1,!0);i.push(Yi(e).J("collectionPathOverlayIndex",r))})),oe.waitFor(i)}getOverlaysForCollection(e,t,n){const r=Gn(),i=xe(t),o=IDBKeyRange.bound([this.userId,i,n],[this.userId,i,Number.POSITIVE_INFINITY],!0);return Yi(e).j("collectionPathOverlayIndex",o).next((e=>{for(const t of e){const e=Gi(this.serializer,t);r.set(e.getKey(),e)}return r}))}getOverlaysForCollectionGroup(e,t,n,r){const i=Gn();let o;const s=IDBKeyRange.bound([this.userId,t,n],[this.userId,t,Number.POSITIVE_INFINITY],!0);return Yi(e).X({index:"collectionGroupOverlayIndex",range:s},((e,t,n)=>{const s=Gi(this.serializer,t);i.size()<r||s.largestBatchId===o?(i.set(s.getKey(),s),o=s.largestBatchId):n.done()})).next((()=>i))}we(e,t){return Yi(e).put(function(e,t,n){const[r,i,o]=$i(t,n.mutation.key);return{userId:t,collectionPath:i,documentId:o,collectionGroup:n.mutation.key.getCollectionGroup(),largestBatchId:n.largestBatchId,overlayMutation:xi(e.fe,n.mutation)}}(this.serializer,this.userId,t))}}function Yi(e){return Xe(e,"documentOverlays")}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uo{constructor(e){this.collectionId=null!=e.collectionGroup?e.collectionGroup:e.path.lastSegment(),this.Ye=e.orderBy,this.Xe=[];for(const t of e.filters){const e=t;e.isInequality()?this.Ze=e:this.Xe.push(e)}}tn(e){x(e.collectionGroup===this.collectionId);const t=H(e);if(void 0!==t&&!this.en(t))return!1;const n=X(e);let r=0,i=0;for(;r<n.length&&this.en(n[r]);++r);if(r===n.length)return!0;if(void 0!==this.Ze){const e=n[r];if(!this.nn(this.Ze,e)||!this.sn(this.Ye[i++],e))return!1;++r}for(;r<n.length;++r){const e=n[r];if(i>=this.Ye.length||!this.sn(this.Ye[i++],e))return!1}return!0}en(e){for(const t of this.Xe)if(this.nn(t,e))return!0;return!1}nn(e,t){if(void 0===e||!e.field.isEqual(t.fieldPath))return!1;const n="array-contains"===e.op||"array-contains-any"===e.op;return 2===t.kind===n}sn(e,t){return!!e.field.isEqual(t.fieldPath)&&(0===t.kind&&"asc"===e.dir||1===t.kind&&"desc"===e.dir)}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lo(e){var t,n;if(x(e instanceof Ht||e instanceof Xt),e instanceof Ht){if(e instanceof ln){const r=(null===(n=null===(t=e.value.arrayValue)||void 0===t?void 0:t.values)||void 0===n?void 0:n.map((t=>Ht.create(e.field,"==",t))))||[];return Xt.create(r,"or")}return e}const r=e.filters.map((e=>lo(e)));return Xt.create(r,e.op)}function ho(e){if(0===e.getFilters().length)return[];const t=go(lo(e));return x(mo(t)),fo(t)||po(t)?[t]:t.getFilters()}function fo(e){return e instanceof Ht}function po(e){return e instanceof Xt&&Yt(e)}function mo(e){return fo(e)||po(e)||function(e){if(e instanceof Xt&&Jt(e)){for(const t of e.getFilters())if(!fo(t)&&!po(t))return!1;return!0}return!1}(e)}function go(e){if(x(e instanceof Ht||e instanceof Xt),e instanceof Ht)return e;if(1===e.filters.length)return go(e.filters[0]);const t=e.filters.map((e=>go(e)));let n=Xt.create(t,e.op);return n=wo(n),mo(n)?n:(x(n instanceof Xt),x(Qt(n)),x(n.filters.length>1),n.filters.reduce(((e,t)=>yo(e,t))))}function yo(e,t){let n;return x(e instanceof Ht||e instanceof Xt),x(t instanceof Ht||t instanceof Xt),n=e instanceof Ht?t instanceof Ht?function(e,t){return Xt.create([e,t],"and")}(e,t):vo(e,t):t instanceof Ht?vo(t,e):function(e,t){if(x(e.filters.length>0&&t.filters.length>0),Qt(e)&&Qt(t))return nn(e,t.getFilters());const n=Jt(e)?e:t,r=Jt(e)?t:e,i=n.filters.map((e=>yo(e,r)));return Xt.create(i,"or")}(e,t),wo(n)}function vo(e,t){if(Qt(t))return nn(t,e.getFilters());{const n=t.filters.map((t=>yo(e,t)));return Xt.create(n,"or")}}function wo(e){if(x(e instanceof Ht||e instanceof Xt),e instanceof Ht)return e;const t=e.getFilters();if(1===t.length)return wo(t[0]);if(Zt(e))return e;const n=t.map((e=>wo(e))),r=[];return n.forEach((t=>{t instanceof Ht?r.push(t):t instanceof Xt&&(t.op===e.op?r.push(...t.filters):r.push(t))})),1===r.length?r[0]:Xt.create(r,e.op)
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oo(e,t,n){const r=e.store("mutations"),i=e.store("documentMutations"),o=[],s=IDBKeyRange.only(n.batchId);let a=0;const c=r.X({range:s},((e,t,n)=>(a++,n.delete())));o.push(c.next((()=>{x(1===a)})));const u=[];for(const e of n.mutations){const r=Te(t,e.key.path,n.batchId);o.push(i.delete(r)),u.push(e.key)}return oe.waitFor(o).next((()=>u))}function Do(e){if(!e)return 0;let t;if(e.document)t=e.document;else if(e.unknownDocument)t=e.unknownDocument;else{if(!e.noDocument)throw b();t=e.noDocument}return JSON.stringify(t).length}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uo{constructor(e){this.Nn=e}next(){return this.Nn+=2,this.Nn}static kn(){return new Uo(0)}static Mn(){return new Uo(-1)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ho{constructor(e,t){this.db=e,this.garbageCollector=Ko(this,t)}zn(e){const t=this.Jn(e);return this.db.getTargetCache().getTargetCount(e).next((e=>t.next((t=>e+t))))}Jn(e){let t=0;return this.Wn(e,(e=>{t++})).next((()=>t))}forEachTarget(e,t){return this.db.getTargetCache().forEachTarget(e,t)}Wn(e,t){return this.Yn(e,((e,n)=>t(n)))}addReference(e,t,n){return Xo(e,n)}removeReference(e,t,n){return Xo(e,n)}removeTargets(e,t,n){return this.db.getTargetCache().removeTargets(e,t,n)}markPotentiallyOrphaned(e,t){return Xo(e,t)}Xn(e,t){return function(e,t){let n=!1;return Fo(e).Z((r=>Po(e,r,t).next((e=>(e&&(n=!0),oe.resolve(!e)))))).next((()=>n))}(e,t)}removeOrphanedDocuments(e,t){const n=this.db.getRemoteDocumentCache().newChangeBuffer(),r=[];let i=0;return this.Yn(e,((o,s)=>{if(s<=t){const t=this.Xn(e,o).next((t=>{if(!t)return i++,n.getEntry(e,o).next((()=>(n.removeEntry(o,V.min()),zo(e).delete([0,xe(o.path)]))))}));r.push(t)}})).next((()=>oe.waitFor(r))).next((()=>n.apply(e))).next((()=>i))}removeTarget(e,t){const n=t.withSequenceNumber(e.currentSequenceNumber);return this.db.getTargetCache().updateTargetData(e,n)}updateLimboDocument(e,t){return Xo(e,t)}Yn(e,t){const n=zo(e);let r,i=ye.ct;return n.X({index:"documentTargetsIndex"},(([e,n],{path:o,sequenceNumber:s})=>{0===e?(i!==ye.ct&&t(new $(ke(r)),i),i=s,r=o):i=ye.ct})).next((()=>{i!==ye.ct&&t(new $(ke(r)),i)}))}getCacheSize(e){return this.db.getRemoteDocumentCache().getSize(e)}}function Xo(e,t){return zo(e).put(function(e,t){return{targetId:0,path:xe(e.path),sequenceNumber:t}}(t,e.currentSequenceNumber))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qo{constructor(){this.changes=new jn((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Vt.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return void 0!==n?oe.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}class _s{constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.Fi=n,this.Bi=r}static Li(e,t){let n=Qn(),r=Qn();for(const e of t.docChanges)switch(e.type){case 0:n=n.add(e.doc.key);break;case 1:r=r.add(e.doc.key)}return new _s(e,t.fromCache,n,r)}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ss{constructor(){this.qi=!1}initialize(e,t){this.Ui=e,this.indexManager=t,this.qi=!0}getDocumentsMatchingQuery(e,t,n,r){return this.Ki(e,t).next((i=>i||this.Gi(e,t,r,n))).next((n=>n||this.Qi(e,t)))}Ki(e,t){if(kn(t))return oe.resolve(null);let n=Nn(t);return this.indexManager.getIndexType(e,n).next((r=>0===r?null:(null!==t.limit&&1===r&&(t=On(t,null,"F"),n=Nn(t)),this.indexManager.getDocumentsMatchingTarget(e,n).next((r=>{const i=Qn(...r);return this.Ui.getDocuments(e,i).next((r=>this.indexManager.getMinOffset(e,n).next((n=>{const o=this.ji(t,r);return this.zi(t,o,i,n.readTime)?this.Ki(e,On(t,null,"F")):this.Wi(e,o,t,n)}))))})))))}Gi(e,t,n,r){return kn(t)||r.isEqual(V.min())?this.Qi(e,t):this.Ui.getDocuments(e,n).next((i=>{const o=this.ji(t,i);return this.zi(t,o,n,r)?this.Qi(e,t):(p()<=s.LogLevel.DEBUG&&g("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),Pn(t)),this.Wi(e,o,t,Y(r,-1)))}))}ji(e,t){let n=new nt(Fn(e));return t.forEach(((t,r)=>{Ln(e,r)&&(n=n.add(r))})),n}zi(e,t,n,r){if(null===e.limit)return!1;if(n.size!==t.size)return!0;const i="F"===e.limitType?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}Qi(e,t){return p()<=s.LogLevel.DEBUG&&g("QueryEngine","Using full collection scan to execute query:",Pn(t)),this.Ui.getDocumentsMatchingQuery(e,t,ee.min())}Wi(e,t,n,r){return this.Ui.getDocumentsMatchingQuery(e,n,r).next((e=>(t.forEach((t=>{e=e.insert(t.key,t)})),e)))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Js{constructor(){this.Xr=()=>this.Zr(),this.eo=()=>this.no(),this.so=[],this.io()}Yr(e){this.so.push(e)}shutdown(){window.removeEventListener("online",this.Xr),window.removeEventListener("offline",this.eo)}io(){window.addEventListener("online",this.Xr),window.addEventListener("offline",this.eo)}Zr(){g("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.so)e(0)}no(){g("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.so)e(1)}static D(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ys=null;function Zs(){return null===Ys?Ys=268435456+Math.round(2147483648*Math.random()):Ys++,"0x"+Ys.toString(16)
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ka{constructor(){this.Nu=void 0,this.listeners=[]}}class Ha{constructor(){this.queries=new jn((e=>Rn(e)),Dn),this.onlineState="Unknown",this.ku=new Set}}async function Xa(e,t){const n=E(e),r=t.query;let i=!1,o=n.queries.get(r);if(o||(i=!0,o=new Ka),i)try{o.Nu=await n.onListen(r)}catch(e){const n=qa(e,`Initialization of query '${Pn(t.query)}' failed`);return void t.onError(n)}n.queries.set(r,o),o.listeners.push(t),t.Mu(n.onlineState),o.Nu&&t.$u(o.Nu)&&Za(n)}async function Qa(e,t){const n=E(e),r=t.query;let i=!1;const o=n.queries.get(r);if(o){const e=o.listeners.indexOf(t);e>=0&&(o.listeners.splice(e,1),i=0===o.listeners.length)}if(i)return n.queries.delete(r),n.onUnlisten(r)}function Ja(e,t){const n=E(e);let r=!1;for(const e of t){const t=e.query,i=n.queries.get(t);if(i){for(const t of i.listeners)t.$u(e)&&(r=!0);i.Nu=e}}r&&Za(n)}function Ya(e,t,n){const r=E(e),i=r.queries.get(t);if(i)for(const e of i.listeners)e.onError(n);r.queries.delete(t)}function Za(e){e.ku.forEach((e=>{e.next()}))}class ec{constructor(e,t,n){this.query=e,this.Ou=t,this.Fu=!1,this.Bu=null,this.onlineState="Unknown",this.options=n||{}}$u(e){if(!this.options.includeMetadataChanges){const t=[];for(const n of e.docChanges)3!==n.type&&t.push(n);e=new $a(e.query,e.docs,e.oldDocs,t,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.Fu?this.Lu(e)&&(this.Ou.next(e),t=!0):this.qu(e,this.onlineState)&&(this.Uu(e),t=!0),this.Bu=e,t}onError(e){this.Ou.error(e)}Mu(e){this.onlineState=e;let t=!1;return this.Bu&&!this.Fu&&this.qu(this.Bu,e)&&(this.Uu(this.Bu),t=!0),t}qu(e,t){if(!e.fromCache)return!0;const n="Offline"!==t;return(!this.options.Ku||!n)&&(!e.docs.isEmpty()||e.hasCachedResults||"Offline"===t)}Lu(e){if(e.docChanges.length>0)return!0;const t=this.Bu&&this.Bu.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&!0===this.options.includeMetadataChanges}Uu(e){e=$a.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.Fu=!0,this.Ou.next(e)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Du=-1;class Ru extends wu{constructor(e,t,n,r){super(e,t,n,r),this.type="firestore",this._queue=new Nu,this._persistenceKey=(null==r?void 0:r.name)||"[DEFAULT]"}_terminate(){return this._firestoreClient||Lu(this),this._firestoreClient.terminate()}}function Pu(e){return e._firestoreClient||Lu(e),e._firestoreClient.verifyNotTerminated(),e._firestoreClient}function Lu(e){var t,n,r;const i=e._freezeSettings(),o=function(e,t,n,r){return new gt(e,t,n,r.host,r.ssl,r.experimentalForceLongPolling,r.experimentalAutoDetectLongPolling,uu(r.experimentalLongPollingOptions),r.useFetchStreams)}(e._databaseId,(null===(t=e._app)||void 0===t?void 0:t.options.appId)||"",e._persistenceKey,i);e._firestoreClient=new Hc(e._authCredentials,e._appCheckCredentials,e._queue,o),(null===(n=i.cache)||void 0===n?void 0:n._offlineComponentProvider)&&(null===(r=i.cache)||void 0===r?void 0:r._onlineComponentProvider)&&(e._firestoreClient._uninitializedComponentsProvider={_offlineKind:i.cache.kind,_offline:i.cache._offlineComponentProvider,_online:i.cache._onlineComponentProvider})}function Mu(e,t){Gu(e=gu(e,Ru));const n=Pu(e);if(n._uninitializedComponentsProvider)throw new _(k.FAILED_PRECONDITION,"SDK cache is already specified.");v("enableIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const r=e._freezeSettings(),i=new zc;return Uu(n,i,new Bc(i,r.cacheSizeBytes,null==t?void 0:t.forceOwnership))}function Fu(e){Gu(e=gu(e,Ru));const t=Pu(e);if(t._uninitializedComponentsProvider)throw new _(k.FAILED_PRECONDITION,"SDK cache is already specified.");v("enableMultiTabIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const n=e._freezeSettings(),r=new zc;return Uu(t,r,new Vc(r,n.cacheSizeBytes))}function Uu(e,t,n){const r=new S;return e.asyncQueue.enqueue((async()=>{try{await Xc(e,n),await Qc(e,t),r.resolve()}catch(e){const t=e;if(!Jc(t))throw t;v("Error enabling indexeddb cache. Falling back to memory cache: "+t),r.reject(t)}})).then((()=>r.promise))}function ju(e){if(e._initialized&&!e._terminated)throw new _(k.FAILED_PRECONDITION,"Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");const t=new S;return e._queue.enqueueAndForgetEvenWhileRestricted((async()=>{try{await async function(e){if(!ae.D())return Promise.resolve();const t=e+"main";await ae.delete(t)}(ks(e._databaseId,e._persistenceKey)),t.resolve()}catch(e){t.reject(e)}})),t.promise}function Bu(e){return function(e){const t=new S;return e.asyncQueue.enqueueAndForget((async()=>async function(e,t){const n=E(e);Ia(n.remoteStore)||g("SyncEngine","The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");try{const e=await function(e){const t=E(e);return t.persistence.runTransaction("Get highest unacknowledged batch id","readonly",(e=>t.mutationQueue.getHighestUnacknowledgedBatchId(e)))}(n.localStore);if(-1===e)return void t.resolve();const r=n.Ec.get(e)||[];r.push(t),n.Ec.set(e,r)}catch(e){const n=qa(e,"Initialization of waitForPendingWrites() operation failed");t.reject(n)}}(await ru(e),t))),t.promise}(Pu(e=gu(e,Ru)))}function Vu(e){return function(e){return e.asyncQueue.enqueue((async()=>{const t=await eu(e),n=await nu(e);return t.setNetworkEnabled(!0),function(e){const t=E(e);return t.vu.delete(0),pa(t)}(n)}))}(Pu(e=gu(e,Ru)))}function zu(e){return function(e){return e.asyncQueue.enqueue((async()=>{const t=await eu(e),n=await nu(e);return t.setNetworkEnabled(!1),async function(e){const t=E(e);t.vu.add(0),await ma(t),t.bu.set("Offline")}(n)}))}(Pu(e=gu(e,Ru)))}function qu(e,t){const n=Pu(e=gu(e,Ru)),r=new Ou;return cu(n,e._databaseId,t,r),r}function Wu(e,t){return function(e,t){return e.asyncQueue.enqueue((async()=>function(e,t){const n=E(e);return n.persistence.runTransaction("Get named query","readonly",(e=>n.qs.getNamedQuery(e,t)))}(await tu(e),t)))}(Pu(e=gu(e,Ru)),t).then((t=>t?new Iu(e,null,t.query):null))}function Gu(e){if(e._initialized||e._terminated)throw new _(k.FAILED_PRECONDITION,"Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ku{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new _(k.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new G(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xu{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new _(k.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new _(k.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return F(this._lat,e._lat)||F(this._long,e._long)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xl(e,t,n){let r;return r=e?n&&(n.merge||n.mergeFields)?e.toFirestore(t,n):e.toFirestore(t):t,r}class Ql extends Hl{constructor(e){super(),this.firestore=e}convertBytes(e){return new $u(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new xu(this.firestore,null,t)}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rh(e){e=gu(e,xu);const t=gu(e.firestore,Ru);return su(Pu(t),e._key).then((n=>yh(t,e,n)))}class ih extends Hl{constructor(e){super(),this.firestore=e}convertBytes(e){return new $u(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new xu(this.firestore,null,t)}}function oh(e){e=gu(e,xu);const t=gu(e.firestore,Ru),n=Pu(t),r=new ih(t);return function(e,t){const n=new S;return e.asyncQueue.enqueueAndForget((async()=>async function(e,t,n){try{const r=await function(e,t){const n=E(e);return n.persistence.runTransaction("read document","readonly",(e=>n.localDocuments.getDocument(e,t)))}(e,t);r.isFoundDocument()?n.resolve(r):r.isNoDocument()?n.resolve(null):n.reject(new _(k.UNAVAILABLE,"Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"))}catch(e){const r=qa(e,`Failed to get document '${t} from cache`);n.reject(r)}}(await tu(e),t,n))),n.promise}(n,e._key).then((n=>new Yl(t,r,e._key,n,new Jl(null!==n&&n.hasLocalMutations,!0),e.converter)))}function sh(e){e=gu(e,xu);const t=gu(e.firestore,Ru);return su(Pu(t),e._key,{source:"server"}).then((n=>yh(t,e,n)))}function ah(e){e=gu(e,Iu);const t=gu(e.firestore,Ru),n=Pu(t),r=new ih(t);return _l(e._query),au(n,e._query).then((n=>new eh(t,r,e,n)))}function ch(e){e=gu(e,Iu);const t=gu(e.firestore,Ru),n=Pu(t),r=new ih(t);return function(e,t){const n=new S;return e.asyncQueue.enqueueAndForget((async()=>async function(e,t,n){try{const r=await Ls(e,t,!0),i=new ac(t,r.ir),o=i.sc(r.documents),s=i.applyChanges(o,!1);n.resolve(s.snapshot)}catch(e){const r=qa(e,`Failed to execute query '${t} against cache`);n.reject(r)}}(await tu(e),t,n))),n.promise}(n,e._query).then((n=>new eh(t,r,e,n)))}function uh(e){e=gu(e,Iu);const t=gu(e.firestore,Ru),n=Pu(t),r=new ih(t);return au(n,e._query,{source:"server"}).then((n=>new eh(t,r,e,n)))}function lh(e,t,n){e=gu(e,xu);const r=gu(e.firestore,Ru),i=Xl(e.converter,t,n);return gh(r,[rl(nl(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,gr.none())])}function hh(e,t,n,...r){e=gu(e,xu);const i=gu(e.firestore,Ru),o=nl(i);let s;return s="string"==typeof(t=(0,a.getModularInstance)(t))||t instanceof Ku?hl(o,"updateDoc",e._key,t,n,r):ll(o,"updateDoc",e._key,t),gh(i,[s.toMutation(e._key,gr.exists(!0))])}function dh(e){return gh(gu(e.firestore,Ru),[new Nr(e._key,gr.none())])}function fh(e,t){const n=gu(e.firestore,Ru),r=Su(e),i=Xl(e.converter,t);return gh(n,[rl(nl(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,gr.exists(!1))]).then((()=>r))}function ph(e,...t){var n,r,i;e=(0,a.getModularInstance)(e);let o={includeMetadataChanges:!1},s=0;"object"!=typeof t[s]||Cu(t[s])||(o=t[s],s++);const c={includeMetadataChanges:o.includeMetadataChanges};if(Cu(t[s])){const e=t[s];t[s]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[s+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[s+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}let u,l,h;if(e instanceof xu)l=gu(e.firestore,Ru),h=En(e._key.path),u={next:n=>{t[s]&&t[s](yh(l,e,n))},error:t[s+1],complete:t[s+2]};else{const n=gu(e,Iu);l=gu(n.firestore,Ru),h=n._query;const r=new ih(l);u={next:e=>{t[s]&&t[s](new eh(l,r,n,e))},error:t[s+1],complete:t[s+2]},_l(e._query)}return function(e,t,n,r){const i=new Wc(r),o=new ec(t,i,n);return e.asyncQueue.enqueueAndForget((async()=>Xa(await ou(e),o))),()=>{i.Dc(),e.asyncQueue.enqueueAndForget((async()=>Qa(await ou(e),o)))}}(Pu(l),h,c,u)}function mh(e,t){return function(e,t){const n=new Wc(t);return e.asyncQueue.enqueueAndForget((async()=>function(e,t){E(e).ku.add(t),t.next()}(await ou(e),n))),()=>{n.Dc(),e.asyncQueue.enqueueAndForget((async()=>function(e,t){E(e).ku.delete(t)}(await ou(e),n)))}}(Pu(e=gu(e,Ru)),Cu(t)?t:{next:t})}function gh(e,t){return function(e,t){const n=new S;return e.asyncQueue.enqueueAndForget((async()=>async function(e,t,n){const r=Uc(e);try{const e=await function(e,t){const n=E(e),r=B.now(),i=t.reduce(((e,t)=>e.add(t.key)),Qn());let o,s;return n.persistence.runTransaction("Locally write mutations","readwrite",(e=>{let a=Vn(),c=Qn();return n.Zi.getEntries(e,i).next((e=>{a=e,a.forEach(((e,t)=>{t.isValidDocument()||(c=c.add(e))}))})).next((()=>n.localDocuments.getOverlayedDocuments(e,a))).next((i=>{o=i;const s=[];for(const e of t){const t=Ir(e,o.get(e.key).overlayedDocument);null!=t&&s.push(new _r(e.key,t,Bt(t.value.mapValue),gr.exists(!0)))}return n.mutationQueue.addMutationBatch(e,r,s,t)})).next((t=>{s=t;const r=t.applyToLocalDocumentSet(o,c);return n.documentOverlayCache.saveOverlays(e,t.batchId,r)}))})).then((()=>({batchId:s.batchId,changes:Wn(o)})))}(r.localStore,t);r.sharedClientState.addPendingMutation(e.batchId),function(e,t,n){let r=e.Tc[e.currentUser.toKey()];r||(r=new Ze(F)),r=r.insert(t,n),e.Tc[e.currentUser.toKey()]=r}(r,e.batchId,n),await Sc(r,e.changes),await Na(r.remoteStore)}catch(e){const t=qa(e,"Failed to persist write");n.reject(t)}}(await ru(e),t,n))),n.promise}(Pu(e),t)}function yh(e,t,n){const r=n.docs.get(t._key),i=new ih(e);return new Yl(e,i,t._key,r,new Jl(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xh extends class{constructor(e,t){this._firestore=e,this._transaction=t,this._dataReader=nl(e)}get(e){const t=bh(e,this._firestore),n=new Ql(this._firestore);return this._transaction.lookup([t._key]).then((e=>{if(!e||1!==e.length)return b();const r=e[0];if(r.isFoundDocument())return new Il(this._firestore,n,r.key,r,t.converter);if(r.isNoDocument())return new Il(this._firestore,n,t._key,null,t.converter);throw b()}))}set(e,t,n){const r=bh(e,this._firestore),i=Xl(r.converter,t,n),o=rl(this._dataReader,"Transaction.set",r._key,i,null!==r.converter,n);return this._transaction.set(r._key,o),this}update(e,t,n,...r){const i=bh(e,this._firestore);let o;return o="string"==typeof(t=(0,a.getModularInstance)(t))||t instanceof Ku?hl(this._dataReader,"Transaction.update",i._key,t,n,r):ll(this._dataReader,"Transaction.update",i._key,t),this._transaction.update(i._key,o),this}delete(e){const t=bh(e,this._firestore);return this._transaction.delete(t._key),this}}{constructor(e,t){super(e,t),this._firestore=e}get(e){const t=bh(e,this._firestore),n=new ih(this._firestore);return super.get(e).then((e=>new Yl(this._firestore,n,t._key,e._document,new Jl(!1,!1),t.converter)))}}function Ih(e,t,n){e=gu(e,Ru);const r=Object.assign(Object.assign({},vh),n);return function(e){if(e.maxAttempts<1)throw new _(k.INVALID_ARGUMENT,"Max attempts must be at least 1")}(r),function(e,t,n){const r=new S;return e.asyncQueue.enqueueAndForget((async()=>{const i=await iu(e);new Kc(e.asyncQueue,i,n,t,r).run()})),r.promise}(Pu(e),(n=>t(new xh(e,n))),r)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eh(){return new il("deleteField")}function kh(){return new sl("serverTimestamp")}function _h(...e){return new al("arrayUnion",e)}function Sh(...e){return new cl("arrayRemove",e)}function Th(e){return new ul("increment",e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(e,t=!0){!function(e){d=e}(r.SDK_VERSION),(0,r._registerComponent)(new(0,i.Component)("firestore",((e,{instanceIdentifier:n,options:r})=>{const i=e.getProvider("app").getImmediate(),o=new Ru(new C(e.getProvider("auth-internal")),new P(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new _(k.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new yt(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:t},r),o._setSettings(r),o}),"PUBLIC").setMultipleInstances(!0)),(0,r.registerVersion)(l,"3.12.0",e),(0,r.registerVersion)(l,"3.12.0","esm2017")}()})),o.register("MjY8E",(function(t,n){e(t.exports,"_DEFAULT_ENTRY_NAME",(function(){return d})),e(t.exports,"_apps",(function(){return p})),e(t.exports,"_components",(function(){return m})),e(t.exports,"_addComponent",(function(){return g})),e(t.exports,"_addOrOverwriteComponent",(function(){return y})),e(t.exports,"_registerComponent",(function(){return v})),e(t.exports,"_getProvider",(function(){return w})),e(t.exports,"_removeServiceInstance",(function(){return b})),e(t.exports,"_clearComponents",(function(){return x})),e(t.exports,"SDK_VERSION",(function(){return _})),e(t.exports,"initializeApp",(function(){return S})),e(t.exports,"getApp",(function(){return T})),e(t.exports,"getApps",(function(){return A})),e(t.exports,"deleteApp",(function(){return N})),e(t.exports,"registerVersion",(function(){return C})),e(t.exports,"onLog",(function(){return O})),e(t.exports,"setLogLevel",(function(){return D})),e(t.exports,"FirebaseError",(function(){return o("2xDiJ").FirebaseError}));var r=o("6ExWU"),i=o("kZfxc"),s=o("2xDiJ"),a=(s=o("2xDiJ"),o("ajgRO"));
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R="firebase-heartbeat-database",P=1,L="firebase-heartbeat-store";let M=null;function F(){return M||(M=(0,a.openDB)(R,P,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(L)}}).catch((e=>{throw E.create("idb-open",{originalErrorMessage:e.message})}))),M}async function U(e,t){try{const n=(await F()).transaction(L,"readwrite"),r=n.objectStore(L);await r.put(t,j(e)),await n.done}catch(e){if(e instanceof s.FirebaseError)h.warn(e.message);else{const t=E.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});h.warn(t.message)}}}function j(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var W;W="",v(new(0,r.Component)("platform-logger",(e=>new c(e)),"PRIVATE")),v(new(0,r.Component)("heartbeat",(e=>new B(e)),"PRIVATE")),C(u,l,W),C(u,l,"esm2017"),C("fire-js","")})),o.register("6ExWU",(function(t,n){e(t.exports,"Component",(function(){return i})),e(t.exports,"ComponentContainer",(function(){return c}));var r=o("2xDiJ");class i{constructor(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
o("kP9ko").default.registerVersion("firebase","9.22.0","app-compat")})),o.register("kP9ko",(function(t,n){e(t.exports,"default",(function(){return f}));var r=o("2xDiJ"),i=o("6ExWU"),s=o("MjY8E"),a=(s=o("MjY8E"),o("kZfxc"));
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */C.Persistence=g;class R{constructor(){this.providerId="phone",this._delegate=new i.P(E(r.default.auth()))}static credential(e,t){return i.P.credential(e,t)}verifyPhoneNumber(e,t){return this._delegate.verifyPhoneNumber(e,t)}unwrap(){return this._delegate}}R.PHONE_SIGN_IN_METHOD=i.P.PHONE_SIGN_IN_METHOD,R.PROVIDER_ID=i.P.PROVIDER_ID;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var M;(M=r.default).INTERNAL.registerComponent(new(0,a.Component)("auth-compat",(e=>{const t=e.getProvider("app-compat").getImmediate(),n=e.getProvider("auth");return new C(t,n)}),"PUBLIC").setServiceProps({ActionCodeInfo:{Operation:{EMAIL_SIGNIN:i.A.EMAIL_SIGNIN,PASSWORD_RESET:i.A.PASSWORD_RESET,RECOVER_EMAIL:i.A.RECOVER_EMAIL,REVERT_SECOND_FACTOR_ADDITION:i.A.REVERT_SECOND_FACTOR_ADDITION,VERIFY_AND_CHANGE_EMAIL:i.A.VERIFY_AND_CHANGE_EMAIL,VERIFY_EMAIL:i.A.VERIFY_EMAIL}},EmailAuthProvider:i.Q,FacebookAuthProvider:i.U,GithubAuthProvider:i.W,GoogleAuthProvider:i.V,OAuthProvider:i.X,SAMLAuthProvider:i.Y,PhoneAuthProvider:R,PhoneMultiFactorGenerator:i.m,RecaptchaVerifier:L,TwitterAuthProvider:i.Z,Auth:C,AuthCredential:i.J,Error:c.FirebaseError}).setInstantiationMode("LAZY").setMultipleInstances(!1)),M.registerVersion("@firebase/auth-compat","0.4.2")})),o.register("beEBC",(function(t,n){e(t.exports,"cordovaPopupRedirectResolver",(function(){return g})),e(t.exports,"addFrameworkForLogging",(function(){return v})),e(t.exports,"ActionCodeOperation",(function(){return o("G0OFq").A})),e(t.exports,"AuthCredential",(function(){return o("G0OFq").J})),e(t.exports,"EmailAuthProvider",(function(){return o("G0OFq").Q})),e(t.exports,"FacebookAuthProvider",(function(){return o("G0OFq").U})),e(t.exports,"GithubAuthProvider",(function(){return o("G0OFq").W})),e(t.exports,"GoogleAuthProvider",(function(){return o("G0OFq").V})),e(t.exports,"OAuthCredential",(function(){return o("G0OFq").L})),e(t.exports,"OAuthProvider",(function(){return o("G0OFq").X})),e(t.exports,"PhoneAuthProvider",(function(){return o("G0OFq").P})),e(t.exports,"PhoneMultiFactorGenerator",(function(){return o("G0OFq").m})),e(t.exports,"ProviderId",(function(){return o("G0OFq").p})),e(t.exports,"RecaptchaVerifier",(function(){return o("G0OFq").R})),e(t.exports,"SAMLAuthCredential",(function(){return o("G0OFq").aO})),e(t.exports,"SAMLAuthProvider",(function(){return o("G0OFq").Y})),e(t.exports,"TwitterAuthProvider",(function(){return o("G0OFq").Z})),e(t.exports,"_assert",(function(){return o("G0OFq").aA})),e(t.exports,"_castAuth",(function(){return o("G0OFq").aH})),e(t.exports,"_fail",(function(){return o("G0OFq").av})),e(t.exports,"_generateEventId",(function(){return o("G0OFq").aL})),e(t.exports,"_getInstance",(function(){return o("G0OFq").aC})),e(t.exports,"_getRedirectResult",(function(){return o("G0OFq").aE})),e(t.exports,"_overrideRedirectResult",(function(){return o("G0OFq").aF})),e(t.exports,"_persistenceKeyName",(function(){return o("G0OFq").aD})),e(t.exports,"applyActionCode",(function(){return o("G0OFq").a5})),e(t.exports,"browserLocalPersistence",(function(){return o("G0OFq").b})),e(t.exports,"browserPopupRedirectResolver",(function(){return o("G0OFq").k})),e(t.exports,"browserSessionPersistence",(function(){return o("G0OFq").a})),e(t.exports,"checkActionCode",(function(){return o("G0OFq").a6})),e(t.exports,"confirmPasswordReset",(function(){return o("G0OFq").a4})),e(t.exports,"connectAuthEmulator",(function(){return o("G0OFq").I})),e(t.exports,"createUserWithEmailAndPassword",(function(){return o("G0OFq").a8})),e(t.exports,"debugErrorMap",(function(){return o("G0OFq").D})),e(t.exports,"fetchSignInMethodsForEmail",(function(){return o("G0OFq").ad})),e(t.exports,"getAdditionalUserInfo",(function(){return o("G0OFq").ao})),e(t.exports,"getMultiFactorResolver",(function(){return o("G0OFq").aq})),e(t.exports,"getRedirectResult",(function(){return o("G0OFq").j})),e(t.exports,"inMemoryPersistence",(function(){return o("G0OFq").N})),e(t.exports,"indexedDBLocalPersistence",(function(){return o("G0OFq").i})),e(t.exports,"isSignInWithEmailLink",(function(){return o("G0OFq").ab})),e(t.exports,"linkWithCredential",(function(){return o("G0OFq").a0})),e(t.exports,"linkWithPhoneNumber",(function(){return o("G0OFq").l})),e(t.exports,"linkWithPopup",(function(){return o("G0OFq").d})),e(t.exports,"linkWithRedirect",(function(){return o("G0OFq").g})),e(t.exports,"multiFactor",(function(){return o("G0OFq").ar})),e(t.exports,"reauthenticateWithCredential",(function(){return o("G0OFq").a1})),e(t.exports,"reauthenticateWithPhoneNumber",(function(){return o("G0OFq").r})),e(t.exports,"reauthenticateWithPopup",(function(){return o("G0OFq").e})),e(t.exports,"reauthenticateWithRedirect",(function(){return o("G0OFq").h})),e(t.exports,"sendEmailVerification",(function(){return o("G0OFq").ae})),e(t.exports,"sendPasswordResetEmail",(function(){return o("G0OFq").a3})),e(t.exports,"sendSignInLinkToEmail",(function(){return o("G0OFq").aa})),e(t.exports,"signInAnonymously",(function(){return o("G0OFq")._})),e(t.exports,"signInWithCredential",(function(){return o("G0OFq").$})),e(t.exports,"signInWithCustomToken",(function(){return o("G0OFq").a2})),e(t.exports,"signInWithEmailAndPassword",(function(){return o("G0OFq").a9})),e(t.exports,"signInWithEmailLink",(function(){return o("G0OFq").ac})),e(t.exports,"signInWithPhoneNumber",(function(){return o("G0OFq").s})),e(t.exports,"signInWithPopup",(function(){return o("G0OFq").c})),e(t.exports,"signInWithRedirect",(function(){return o("G0OFq").f})),e(t.exports,"unlink",(function(){return o("G0OFq").an})),e(t.exports,"updateEmail",(function(){return o("G0OFq").aj})),e(t.exports,"updatePassword",(function(){return o("G0OFq").ak})),e(t.exports,"updatePhoneNumber",(function(){return o("G0OFq").u})),e(t.exports,"updateProfile",(function(){return o("G0OFq").ai})),e(t.exports,"verifyBeforeUpdateEmail",(function(){return o("G0OFq").af})),e(t.exports,"verifyPasswordResetCode",(function(){return o("G0OFq").a7}));var r=o("G0OFq"),i=(r=o("G0OFq"),o("2xDiJ"));
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */o("MjY8E"),o("kZfxc"),o("6ExWU");async function a(e,t,n){var i;const{BuildInfo:o}=s();(0,r.as)(t.sessionId,"AuthEvent did not contain a session ID");const a=await async function(e){const t=function(e){if((0,r.as)(/[0-9a-zA-Z]+/.test(e),"Can only convert alpha-numeric strings"),"undefined"!=typeof TextEncoder)return(new TextEncoder).encode(e);const t=new ArrayBuffer(e.length),n=new Uint8Array(t);for(let t=0;t<e.length;t++)n[t]=e.charCodeAt(t);return n}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function v(e,t){(0,r.aH)(e)._logFramework(t)}})),o.register("G0OFq",(function(t,n){e(t.exports,"p",(function(){return u})),e(t.exports,"A",(function(){return l})),e(t.exports,"D",(function(){return d})),e(t.exports,"av",(function(){return y})),e(t.exports,"az",(function(){return v})),e(t.exports,"aA",(function(){return I})),e(t.exports,"as",(function(){return k})),e(t.exports,"aC",(function(){return J})),e(t.exports,"N",(function(){return Z})),e(t.exports,"aD",(function(){return ee})),e(t.exports,"au",(function(){return ae})),e(t.exports,"at",(function(){return le})),e(t.exports,"ay",(function(){return he})),e(t.exports,"aH",(function(){return ke})),e(t.exports,"I",(function(){return Se})),e(t.exports,"J",(function(){return Ne})),e(t.exports,"L",(function(){return Ue})),e(t.exports,"Q",(function(){return ze})),e(t.exports,"X",(function(){return Ge})),e(t.exports,"U",(function(){return $e})),e(t.exports,"V",(function(){return Ke})),e(t.exports,"W",(function(){return He})),e(t.exports,"aO",(function(){return Xe})),e(t.exports,"Y",(function(){return Qe})),e(t.exports,"Z",(function(){return Je})),e(t.exports,"_",(function(){return tt})),e(t.exports,"an",(function(){return ot})),e(t.exports,"$",(function(){return lt})),e(t.exports,"a0",(function(){return ht})),e(t.exports,"a1",(function(){return dt})),e(t.exports,"a2",(function(){return ft})),e(t.exports,"a3",(function(){return vt})),e(t.exports,"a4",(function(){return wt})),e(t.exports,"a5",(function(){return bt})),e(t.exports,"a6",(function(){return xt})),e(t.exports,"a7",(function(){return It})),e(t.exports,"a8",(function(){return Et})),e(t.exports,"a9",(function(){return kt})),e(t.exports,"aa",(function(){return _t})),e(t.exports,"ab",(function(){return St})),e(t.exports,"ac",(function(){return Tt})),e(t.exports,"ad",(function(){return At})),e(t.exports,"ae",(function(){return Nt})),e(t.exports,"af",(function(){return Ct})),e(t.exports,"ai",(function(){return Ot})),e(t.exports,"aj",(function(){return Dt})),e(t.exports,"ak",(function(){return Rt})),e(t.exports,"ao",(function(){return Vt})),e(t.exports,"aq",(function(){return Wt})),e(t.exports,"ar",(function(){return Kt})),e(t.exports,"b",(function(){return Jt})),e(t.exports,"a",(function(){return Zt})),e(t.exports,"aL",(function(){return tn})),e(t.exports,"i",(function(){return mn})),e(t.exports,"R",(function(){return _n})),e(t.exports,"s",(function(){return Tn})),e(t.exports,"l",(function(){return An})),e(t.exports,"r",(function(){return Nn})),e(t.exports,"u",(function(){return On})),e(t.exports,"P",(function(){return Dn})),e(t.exports,"c",(function(){return Bn})),e(t.exports,"e",(function(){return Vn})),e(t.exports,"d",(function(){return zn})),e(t.exports,"aG",(function(){return Hn})),e(t.exports,"aF",(function(){return Xn})),e(t.exports,"f",(function(){return Yn})),e(t.exports,"h",(function(){return Zn})),e(t.exports,"g",(function(){return er})),e(t.exports,"j",(function(){return tr})),e(t.exports,"aE",(function(){return nr})),e(t.exports,"aB",(function(){return ir})),e(t.exports,"ax",(function(){return ar})),e(t.exports,"aw",(function(){return Tr})),e(t.exports,"k",(function(){return Nr})),e(t.exports,"m",(function(){return Dr}));var r=o("2xDiJ"),i=o("MjY8E"),s=o("4tSb9"),a=o("kZfxc"),c=o("6ExWU");
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function R(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}async function P(e,t,n,i,o={}){return L(e,o,(async()=>{let o={},s={};i&&("GET"===t?s=i:o={body:JSON.stringify(i)});const a=(0,r.querystring)(Object.assign({key:e.config.apiKey},s)).slice(1),c=await e._getAdditionalHeaders();return c["Content-Type"]="application/json",e.languageCode&&(c["X-Firebase-Locale"]=e.languageCode),C.fetch()(F(e,e.config.apiHost,n,a),Object.assign({method:t,headers:c,referrerPolicy:"no-referrer"},o))}))}async function L(e,t,n){e._canInitEmulator=!1;const i=Object.assign(Object.assign({},O),t);try{const t=new U(e),r=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw j(e,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const t=r.ok?o.errorMessage:o.error.message,[n,s]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw j(e,"credential-already-in-use",o);if("EMAIL_EXISTS"===n)throw j(e,"email-already-in-use",o);if("USER_DISABLED"===n)throw j(e,"user-disabled",o);const a=i[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(s)throw w(e,a,s);y(e,a)}}catch(t){if(t instanceof r.FirebaseError)throw t;y(e,"network-request-failed",{message:String(t)})}}async function M(e,t,n,r,i={}){const o=await P(e,t,n,r,i);return"mfaPendingCredential"in o&&y(e,"multi-factor-auth-required",{_serverResponse:o}),o}function F(e,t,n,r){const i=`${t}${n}?${r}`;return e.config.emulator?N(e.config,i):`${e.config.apiScheme}://${i}`}class U{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(v(this.auth,"network-request-failed"))),D.get())}))}clearNetworkTimeout(){clearTimeout(this.timer)}}function j(e,t,n){const r={appName:e.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const i=v(e,t,r);return i.customData._tokenResponse=n,i}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class K{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){I(e.idToken,"internal-error"),I(void 0!==e.idToken,"internal-error"),I(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=z(e);return I(t,"internal-error"),I(void 0!==t.exp,"internal-error"),I(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return I(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:o}=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q=new Map;function J(e){k(e instanceof Function,"Expected a class definition");let t=Q.get(e);return t?(k(t instanceof e,"Instance stored in cache mismatched with class"),t):(t=new e,Q.set(e,t),t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return void 0===t?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Y.type="NONE";const Z=Y;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pe(e,t){return P(e,"GET","/v2/recaptchaConfig",R(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */()}function Te(e){const t=e.indexOf(":");return t<0?"":e.substr(0,t+1)}function Ae(e){if(!e)return null;const t=Number(e);return isNaN(t)?null:t}class Ne{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return E("not implemented")}_getIdTokenResponse(e){return E("not implemented")}_linkToIdToken(e,t){return E("not implemented")}_getReauthenticationResolver(e){return E("not implemented")}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ce(e,t){return P(e,"POST","/v1/accounts:resetPassword",R(e,t))}async function Oe(e,t){return P(e,"POST","/v1/accounts:update",t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function De(e,t){return M(e,"POST","/v1/accounts:signInWithPassword",R(e,t))}async function Re(e,t){return P(e,"POST","/v1/accounts:sendOobCode",R(e,t))}async function Pe(e,t){return Re(e,t)}async function Le(e,t){return Re(e,t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fe(e,t){return M(e,"POST","/v1/accounts:signInWithIdp",R(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ke extends We{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return Ue._fromParams({providerId:Ke.PROVIDER_ID,signInMethod:Ke.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return Ke.credentialFromTaggedObject(e)}static credentialFromError(e){return Ke.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:n}=e;if(!t&&!n)return null;try{return Ke.credential(t,n)}catch(e){return null}}}Ke.GOOGLE_SIGN_IN_METHOD="google.com",Ke.PROVIDER_ID="google.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe extends qe{constructor(e){I(e.startsWith("saml."),"argument-error"),super(e)}static credentialFromResult(e){return Qe.samlCredentialFromTaggedObject(e)}static credentialFromError(e){return Qe.samlCredentialFromTaggedObject(e.customData||{})}static credentialFromJSON(e){const t=Xe.fromJSON(e);return I(t,"argument-error"),t}static samlCredentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{pendingToken:t,providerId:n}=e;if(!t||!n)return null;try{return Xe._create(n,t)}catch(e){return null}}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Je extends We{constructor(){super("twitter.com")}static credential(e,t){return Ue._fromParams({providerId:Je.PROVIDER_ID,signInMethod:Je.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Je.credentialFromTaggedObject(e)}static credentialFromError(e){return Je.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:n}=e;if(!t||!n)return null;try{return Je.credential(t,n)}catch(e){return null}}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Ye(e,t){return M(e,"POST","/v1/accounts:signUp",R(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function ft(e,t){const n=ke(e),r=await async function(e,t){return M(e,"POST","/v1/accounts:signInWithCustomToken",R(e,t))}(n,{token:t,returnSecureToken:!0}),i=await Ze._fromIdTokenResponse(n,"signIn",r);return await n._updateCurrentUser(i.user),i}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function At(e,t){const n={identifier:t,continueUri:S()?_():"http://localhost"},{signinMethods:i}=await async function(e,t){return P(e,"POST","/v1/accounts:createAuthUri",R(e,t))}((0,r.getModularInstance)(e),n);return i||[]}async function Nt(e,t){const n=(0,r.getModularInstance)(e),i={requestType:"VERIFY_EMAIL",idToken:await e.getIdToken()};t&&yt(n.auth,i,t);const{email:o}=await async function(e,t){return Re(e,t)}(n.auth,i);o!==e.email&&await e.reload()}async function Ct(e,t,n){const i=(0,r.getModularInstance)(e),o={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await e.getIdToken(),newEmail:t};n&&yt(i.auth,o,n);const{email:s}=await async function(e,t){return Re(e,t)}(i.auth,o);s!==e.email&&await e.reload()}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt{constructor(e,t,n={}){this.isNewUser=e,this.providerId=t,this.profile=n}}class Mt extends Lt{constructor(e,t,n,r){super(e,t,n),this.username=r}}class Ft extends Lt{constructor(e,t){super(e,"facebook.com",t)}}class Ut extends Mt{constructor(e,t){super(e,"github.com",t,"string"==typeof(null==t?void 0:t.login)?null==t?void 0:t.login:null)}}class jt extends Lt{constructor(e,t){super(e,"google.com",t)}}class Bt extends Mt{constructor(e,t,n){super(e,"twitter.com",t,n)}}function Vt(e){const{user:t,_tokenResponse:n}=e;return t.isAnonymous&&!n?{providerId:null,isNewUser:!1,profile:null}:function(e){var t,n;if(!e)return null;const{providerId:r}=e,i=e.rawUserInfo?JSON.parse(e.rawUserInfo):{},o=e.isNewUser||"identitytoolkit#SignupNewUserResponse"===e.kind;if(!r&&(null==e?void 0:e.idToken)){const r=null===(n=null===(t=z(e.idToken))||void 0===t?void 0:t.firebase)||void 0===n?void 0:n.sign_in_provider;if(r)return new Lt(o,"anonymous"!==r&&"custom"!==r?r:null)}if(!r)return null;switch(r){case"facebook.com":return new Ft(o,i);case"github.com":return new Ut(o,i);case"google.com":return new jt(o,i);case"twitter.com":return new Bt(o,i,e.screenName||null);case"custom":case"anonymous":return new Lt(o,null);default:return new Lt(o,r,i)}}(n)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yt extends Xt{constructor(){super((()=>window.sessionStorage),"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Yt.type="SESSION";const Zt=Yt;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(),this.recaptcha=await this._recaptchaLoader.load(this.auth,this.auth.languageCode||void 0);const e=await async function(e){return(await P(e,"GET","/v1/recaptchaParams")).recaptchaSiteKey||""}(this.auth);I(e,this.auth,"internal-error"),this.parameters.sitekey=e}getAssertedRecaptcha(){return I(this.recaptcha,this.auth,"internal-error"),this.recaptcha}}class Sn{constructor(e,t){this.verificationId=e,this.onConfirmation=t}confirm(e){const t=Be._fromVerification(this.verificationId,e);return this.onConfirmation(t)}}async function Tn(e,t,n){const i=ke(e),o=await Cn(i,t,(0,r.getModularInstance)(n));return new Sn(o,(e=>lt(i,e)))}async function An(e,t,n){const i=(0,r.getModularInstance)(e);await at(!1,i,"phone");const o=await Cn(i.auth,t,(0,r.getModularInstance)(n));return new Sn(o,(e=>ht(i,e)))}async function Nn(e,t,n){const i=(0,r.getModularInstance)(e),o=await Cn(i.auth,t,(0,r.getModularInstance)(n));return new Sn(o,(e=>dt(i,e)))}async function Cn(e,t,n){var r;const i=await n.verify();try{let o;if(I("string"==typeof i,e,"argument-error"),I(n.type===En,e,"argument-error"),o="string"==typeof t?{phoneNumber:t}:t,"session"in o){const t=o.session;if("phoneNumber"in o){I("enroll"===t.type,e,"internal-error");const n=await function(e,t){return P(e,"POST","/v2/accounts/mfaEnrollment:start",R(e,t))}(e,{idToken:t.credential,phoneEnrollmentInfo:{phoneNumber:o.phoneNumber,recaptchaToken:i}});return n.phoneSessionInfo.sessionInfo}{I("signin"===t.type,e,"internal-error");const n=(null===(r=o.multiFactorHint)||void 0===r?void 0:r.uid)||o.multiFactorUid;I(n,e,"missing-multi-factor-info");const s=await function(e,t){return P(e,"POST","/v2/accounts/mfaSignIn:start",R(e,t))}(e,{mfaPendingCredential:t.credential,mfaEnrollmentId:n,phoneSignInInfo:{recaptchaToken:i}});return s.phoneResponseInfo.sessionInfo}}{const{sessionInfo:t}=await async function(e,t){return P(e,"POST","/v1/accounts:sendVerificationCode",R(e,t))}(e,{phoneNumber:o.phoneNumber,recaptchaToken:i});return t}}finally{n._reset()}}async function On(e,t){await st((0,r.getModularInstance)(e),t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Rn(e,t){return t?J(t):(I(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Wn="pendingRedirect",Gn=new Map;class $n extends Un{constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}async execute(){let e=Gn.get(this.auth._key());if(!e){try{const t=await async function(e,t){const n=Jn(t),r=Qn(e);if(!await r._isAvailable())return!1;const i="true"===await r._get(n);return await r._remove(n),i}(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(t)}catch(t){e=()=>Promise.reject(t)}Gn.set(this.auth._key(),e)}return this.bypassAuthState||Gn.set(this.auth._key(),(()=>Promise.resolve(null))),e()}async onAuthEvent(e){if("signInViaRedirect"===e.type)return super.onAuthEvent(e);if("unknown"!==e.type){if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}}async function Kn(e,t){return Qn(e)._set(Jn(t),"true")}function Hn(){Gn.clear()}function Xn(e,t){Gn.set(e._key(),t)}function Qn(e){return J(e._redirectPersistence)}function Jn(e){return ee(Wn,e.config.apiKey,e.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yn(e,t,n){return async function(e,t,n){const r=ke(e);b(e,t,qe),await r._initializationPromise;const i=Rn(r,n);return await Kn(i,r),i._openRedirect(r,t,"signInViaRedirect")}(e,t,n)}function Zn(e,t,n){return async function(e,t,n){const i=(0,r.getModularInstance)(e);b(i.auth,t,qe),await i.auth._initializationPromise;const o=Rn(i.auth,n);await Kn(o,i.auth);const s=await rr(i);return o._openRedirect(i.auth,t,"reauthViaRedirect",s)}(e,t,n)}function er(e,t,n){return async function(e,t,n){const i=(0,r.getModularInstance)(e);b(i.auth,t,qe),await i.auth._initializationPromise;const o=Rn(i.auth,n);await at(!1,i,t.providerId),await Kn(o,i.auth);const s=await rr(i);return o._openRedirect(i.auth,t,"linkViaRedirect",s)}(e,t,n)}async function tr(e,t){return await ke(e)._initializationPromise,nr(e,t,!1)}async function nr(e,t,n=!1){const r=ke(e),i=Rn(r,t),o=new $n(r,i,n),s=await o.execute();return s&&!n&&(delete s.user._redirectEventId,await r._persistUserIfCurrent(s.user),await r._setRedirectUser(null,t)),s}async function rr(e){const t=tn(`${e.uid}:::`);return e._redirectEventId=t,await e.auth._setRedirectUser(e),await e.auth._persistUserIfCurrent(e),t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
(0,r.getExperimentalSetting)("authIdTokenMaxAge");var Mr;Mr="Browser",(0,i._registerComponent)(new(0,c.Component)("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:s}=n.options;I(o&&!o.includes(":"),"invalid-api-key",{appName:n.name});const a={apiKey:o,authDomain:s,clientPlatform:Mr,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:fe(Mr)},c=new Ee(n,r,i,a);return function(e,t){const n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(J);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(c,t),c}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),(0,i._registerComponent)(new(0,c.Component)("auth-internal",(e=>(e=>new Lr(e))(ke(e.getProvider("auth").getImmediate()))),"PRIVATE").setInstantiationMode("EXPLICIT")),(0,i.registerVersion)(Rr,Pr,function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Mr)),(0,i.registerVersion)(Rr,Pr,"esm2017")})),o.register("4tSb9",(function(t,n){e(t.exports,"__rest",(function(){return r}));function r(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]])}return n}Object.create;Object.create})),o.register("19hka",(function(e,t){o("i34qx")})),o.register("i34qx",(function(e,t){var n=o("kP9ko"),r=o("221Dt"),i=o("2xDiJ"),s=o("6ExWU");
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O={Firestore:f,GeoPoint:r.GeoPoint,Timestamp:r.Timestamp,Blob:l,Transaction:m,WriteBatch:g,DocumentReference:v,DocumentSnapshot:I,Query:k,QueryDocumentSnapshot:E,QuerySnapshot:S,CollectionReference:T,FieldPath:N,FieldValue:C,setLogLevel:function(e){(0,r.setLogLevel)(e)},CACHE_SIZE_UNLIMITED:r.CACHE_SIZE_UNLIMITED};
/**
 * @license
 * Copyright 2020 Google LLC
 *
